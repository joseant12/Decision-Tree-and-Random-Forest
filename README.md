...
Para Windows, se debe agregar dentro de las variables de entorno, un nuevo path correspondiente a la ubicación del bin (por default es C:\Program Files (x86)\Graphviz2.38\bin)
